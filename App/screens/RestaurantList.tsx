...
function RestaurantList(props: RestaurantListProps) {
  ...
  const [restaurantList, setRestaurantList] = React.useState<Restaurant[]>(
    props.route.params.restaurantList
  );
  ...
  return (
    <ScrollView style={styles.restaurantList}>
      ...
      <View style={styles.row}>
        <Text>Sort by:</Text>
        <TouchableOpacity
          onPress={onPressFilterPriceButton}
          style={styles.sortButton}
        >
          <Text style={styles.sortButtonText}>Price</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={onPressFilterRatingButton}
          style={styles.sortButton}
        >
          <Text style={styles.sortButtonText}>Rating</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={onPressFilterDistanceButton}
          style={styles.sortButton}
        >
      ...
      {restaurantList
        .filter((restaurant) =>
          restaurant.name.toUpperCase().includes(searchText.toUpperCase())
        )

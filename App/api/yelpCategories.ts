...
const yelpCategories: Category[] = [
  ...
  },
  {
    ...
    title: 'Acai Bowls',
    parents: ['food'],
    country_blacklist: ['TR', 'MX', 'AR', 'PL', 'IT', 'CL'],
  },
  {
    alias: 'afghani',
    title: 'Afghan',
  ...
  },
  {
    ...
    title: 'Baguettes',
    parents: ['restaurants'],
    country_whitelist: ['DE', 'MX', 'PT', 'CZ', 'IT', 'SE', 'NO', 'TR'],
  },
  {
    alias: 'bakeries',
    title: 'Bakeries',
  ...
  },
  {
    ...
    title: 'Bangladeshi',
    parents: ['restaurants'],
    country_blacklist: ['DK', 'MX', 'ES', 'PT', 'TR'],
  },
  {
    alias: 'basque',
    title: 'Basque',
    parents: ['restaurants'],
    country_blacklist: ['AU', 'DK', 'CZ', 'SG', 'PT', 'TR'],
  },
  {
    alias: 'bavarian',
    title: 'Bavarian',
  ...
  },
  {
    ...
    title: 'Brewpubs',
    parents: ['breweries'],
    country_blacklist: ['FR', 'ES', 'MX', 'AR', 'IT', 'CL'],
  },
  {
    alias: 'british',
    title: 'British',
  ...
  },
  {
    ...
    title: 'Bubble Tea',
    parents: ['food'],
    country_blacklist: ['TR', 'AT', 'ES', 'MX', 'AR', 'CH'],
  },
  {
    alias: 'buffets',
    title: 'Buffets',
  ...
  },
  {
    ...
    title: 'Bulgarian',
    parents: ['restaurants'],
    country_blacklist: ['NZ', 'NL', 'DK', 'BR', 'CA', 'SG', 'NO', 'TR'],
  },
  {
    alias: 'burgers',
    title: 'Burgers',
  ...
  },
  {
    ...
    title: 'Burmese',
    parents: ['restaurants'],
    country_blacklist: ['FI', 'DK', 'CZ', 'ES', 'PT', 'TR'],
  },
  {
    alias: 'butcher',
    title: 'Butcher',
  ...
  },
  {
    ...
    title: 'Cafes',
    parents: ['restaurants'],
    country_blacklist: ['ES', 'FI', 'AR', 'MX'],
  },
  {
    alias: 'cafeteria',
    title: 'Cafeteria',
    parents: ['restaurants'],
    country_blacklist: ['IE', 'FR', 'BR', 'CA', 'SG', 'SE', 'NZ'],
  },
  {
    alias: 'cajun',
    title: 'Cajun/Creole',
  ...
  },
  {
    ...
    title: 'Catalan',
    parents: ['restaurants'],
    country_whitelist: ['FR', 'US', 'MX', 'AR', 'PT', 'CL', 'IT', 'ES', 'TR'],
  },
  {
  ...
  },
  {
    ...
    title: 'Cheesesteaks',
    parents: ['restaurants'],
    country_whitelist: ['IE', 'AU', 'US', 'PL', 'GB', 'NL', 'CA'],
  },
  {
    alias: 'chicken_wings',
    title: 'Chicken Wings',
  ...
  },
  {
    ...
    title: 'Chilean',
    parents: ['restaurants'],
    country_whitelist: ['FI', 'FR', 'BR', 'CL'],
  },
  {
    alias: 'chimneycakes',
    title: 'Chimney Cakes',
    parents: ['food'],
    country_whitelist: ['US', 'FR', 'CZ', 'PL'],
  },
  {
    alias: 'chinese',
    title: 'Chinese',
  ...
  },
  {
    ...
    title: 'Churros',
    parents: ['food'],
    country_whitelist: ['BR', 'ES', 'MX', 'AR', 'PT', 'CL'],
  },
  {
    alias: 'cideries',
    title: 'Cideries',
    parents: ['food'],
    country_blacklist: ['FR', 'JP', 'DK', 'NO', 'BE', 'IT', 'NL', 'TR'],
  },
  {
    alias: 'coffee',
    title: 'Coffee & Tea',
  ...
  },
  {
    ...
    title: 'Colombian',
    parents: ['latin'],
    country_whitelist: ['FI', 'FR', 'US', 'MX', 'AR', 'CL', 'BE', 'CA', 'ES'],
  },
  {
    alias: 'comfortfood',
    title: 'Comfort Food',
    parents: ['restaurants'],
    country_whitelist: ['FI', 'CA', 'JP', 'US', 'MX', 'AR', 'CL'],
  },
  {
    alias: 'congee',
    title: 'Congee',
    parents: ['chinese'],
    country_whitelist: ['HK', 'SG', 'TW', 'MY'],
  },
  {
    alias: 'convenience',
  ...
  },
  {
    ...
    title: 'CSA',
    parents: ['food'],
    country_whitelist: ['FR', 'DE', 'AT', 'US', 'CH'],
  },
  {
    alias: 'cuban',
    title: 'Cuban',
  ...
  },
  {
    ...
    title: 'Delis',
    parents: ['restaurants'],
    country_blacklist: ['FR', 'BE', 'IT', 'SE', 'NL', 'PT', 'CL'],
  },
  {
    alias: 'desserts',
    title: 'Desserts',
  ...
  },
  {
    ...
    title: 'Diners',
    parents: ['restaurants'],
    country_blacklist: ['AU', 'FI', 'CZ', 'SE'],
  },
  {
    alias: 'dinnertheater',
    title: 'Dinner Theater',
    parents: ['restaurants'],
    country_blacklist: ['FR', 'JP', 'BE', 'IT', 'NL'],
  },
  {
    alias: 'distilleries',
    title: 'Distilleries',
  ...
  },
  {
    ...
    title: 'Donairs',
    parents: ['food'],
    country_whitelist: ['FR', 'DK', 'CZ', 'BE', 'CA', 'PL', 'TR'],
  },
  {
    alias: 'donburi',
    title: 'Donburi',
  ...
  },
  {
    ...
    parents: ['restaurants'],
    country_whitelist: ['AU', 'FR', 'DK', 'CZ', 'NO'],
  },
  {
    alias: 'easterngerman',
  ...
  },
  {
    ...
    title: 'Egyptian',
    parents: ['mideastern'],
    country_whitelist: ['FR', 'BE', 'US', 'IT', 'CA'],
  },
  {
    alias: 'eltern_cafes',
    title: 'Parent Cafes',
  ...
  },
  {
    ...
    title: 'Empanadas',
    parents: ['food'],
    country_whitelist: ['ES', 'AR', 'US', 'CL'],
  },
  {
    alias: 'eritrean',
    title: 'Eritrean',
    parents: ['restaurants'],
    country_whitelist: ['DE', 'AT', 'US', 'IT', 'CH'],
  },
  {
    alias: 'ethicgrocery',
  ...
  },
  {
    ...
    title: 'Flatbread',
    parents: ['restaurants'],
    country_whitelist: ['DK', 'DE', 'AT', 'PL', 'CH'],
  },
  {
    alias: 'flemish',
    title: 'Flemish',
  ...
  },
  {
    ...
    title: 'Friterie',
    parents: ['food'],
    country_whitelist: ['AU', 'FR', 'BE', 'IT', 'PL', 'NL'],
  },
  {
    alias: 'friulan',
    title: 'Friulan',
  ...
  },
  {
    ...
    title: 'Frozen Food',
    parents: ['gourmet'],
    country_whitelist: ['FR', 'BE', 'ES', 'IT', 'SG', 'GB'],
  },
  {
    alias: 'fuzhou',
    title: 'Fuzhou',
  ...
  },
  {
    ...
    title: 'Georgian',
    parents: ['restaurants'],
    country_whitelist: ['FI', 'DE', 'US', 'GB', 'CH', 'CZ', 'AT', 'PL'],
  },
  {
    alias: 'german',
    title: 'German',
  ...
  },
  {
    ...
    title: 'Mulled Wine',
    parents: ['food'],
    country_whitelist: ['DE', 'CZ', 'AT', 'SE', 'CH'],
  },
  {
    alias: 'gluten_free',
    title: 'Gluten-Free',
  ...
  },
  {
    ...
    title: 'Guamanian',
    parents: ['restaurants'],
    country_blacklist: ['TR', 'FR', 'JP', 'MX', 'AR', 'PL', 'CL'],
  },
  {
    alias: 'gyudon',
    title: 'Gyudon',
  ...
  },
  {
    ...
    title: 'Hainan',
    parents: ['chinese'],
    country_whitelist: ['HK', 'PH', 'US', 'SG', 'MY'],
  },
  {
    alias: 'haitian',
    title: 'Haitian',
  ...
  },
  {
    ...
    title: 'Hakka',
    parents: ['chinese'],
    country_whitelist: ['HK', 'PH', 'CA', 'SG', 'TW', 'MY'],
  },
  {
    alias: 'halal',
    title: 'Halal',
  ...
  },
  {
    ...
    title: 'Hawaiian',
    parents: ['restaurants'],
    country_blacklist: ['AU', 'DK', 'CZ', 'PT', 'TR'],
  },
  {
    alias: 'hawkercentre',
    title: 'Hawker Centre',
    parents: ['food'],
    country_whitelist: ['MX', 'AR', 'CL', 'HK', 'PH', 'SG', 'TW', 'MY'],
  },
  {
    alias: 'healthmarkets',
  ...
  },
  {
    ...
    title: 'Honey',
    parents: ['food'],
    country_whitelist: ['FI', 'DE', 'FR', 'US', 'IT', 'PL', 'SE', 'TR'],
  },
  {
    alias: 'horumon',
    title: 'Horumon',
  ...
  },
  {
    ...
    title: 'Hunan',
    parents: ['chinese'],
    country_whitelist: ['HK', 'FR', 'SG', 'TW', 'MY'],
  },
  {
    alias: 'hungarian',
    title: 'Hungarian',
  ...
  },
  {
    ...
    title: 'International',
    parents: ['restaurants'],
    country_blacklist: ['PH', 'FI', 'US', 'IT', 'MY', 'TR'],
  },
  {
    alias: 'internetcafe',
  ...
  },
  {
    ...
    title: 'Izakaya',
    parents: ['japanese'],
    country_whitelist: ['JP', 'US', 'MX', 'NZ', 'HK', 'AU', 'BR', 'SG', 'TW'],
  },
  {
    alias: 'jaliscan',
    title: 'Jaliscan',
  ...
  },
  {
    ...
    parents: ['japanese'],
    country_whitelist: ['HK', 'JP', 'US', 'SG', 'TW'],
  },
  {
    alias: 'japanese',
    title: 'Japanese',
  ...
  },
  {
    ...
    title: 'Meaderies',
    parents: ['food'],
    country_whitelist: ['DE', 'US', 'MX', 'AR', 'CL', 'CH', 'AT', 'ES', 'PL'],
  },
  {
    alias: 'meatballs',
    title: 'Meatballs',
    parents: ['restaurants'],
    country_whitelist: ['TR', 'FR', 'NL', 'BE'],
  },
  {
    alias: 'meats',
    title: 'Meat Shops',
  ...
  },
  {
    ...
    title: 'American (New)',
    parents: ['restaurants'],
    country_whitelist: ['IE', 'DK', 'US', 'GB', 'NO', 'SE'],
  },
  {
    alias: 'newcanadian',
    title: 'Canadian (New)',
  ...
  },
  {
    ...
    title: 'Night Food',
    parents: ['restaurants'],
    country_whitelist: ['DK', 'PL', 'SE', 'NO', 'TR'],
  },
  {
    alias: 'nikkei',
    title: 'Nikkei',
    parents: ['restaurants'],
    country_whitelist: ['BR', 'ES', 'MX', 'AR', 'CL'],
  },
  {
    alias: 'noodles',
    title: 'Noodles',
  ...
  },
  {
    ...
    title: 'Olive Oil',
    parents: ['gourmet'],
    country_whitelist: ['BE', 'FR', 'DE', 'AT', 'US', 'ES'],
  },
  {
    alias: 'onigiri',
    title: 'Onigiri',
  ...
  },
  {
    ...
    title: 'Oriental',
    parents: ['restaurants'],
    country_whitelist: ['FR', 'DE', 'AT', 'PL', 'PT', 'CH'],
  },
  {
  ...
  },
  {
    ...
    title: 'Pekinese',
    parents: ['chinese'],
    country_whitelist: ['HK', 'FR', 'JP', 'IT', 'SG', 'TW', 'MY'],
  },
  {
    alias: 'persian',
  ...
  },
  {
    ...
    title: 'Romanian',
    parents: ['restaurants'],
    country_whitelist: ['FR', 'DE', 'AT', 'CH', 'CZ', 'BE', 'ES', 'PL'],
  },
  {
  ...
  },
  {
    ...
    title: 'Salumerie',
    parents: ['food'],
    country_whitelist: ['IT', 'ES', 'MX', 'AR', 'PT', 'CL'],
  },
  {
    alias: 'salvadoran',
    title: 'Salvadoran',
  ...
  },
  {
    ...
    title: 'Schnitzel',
    parents: ['restaurants'],
    country_whitelist: ['CH', 'DE', 'PL', 'AT'],
  },
  {
    alias: 'scottish',
    title: 'Scottish',
    parents: ['restaurants'],
    country_whitelist: ['IE', 'DE', 'CA', 'AT', 'US', 'GB', 'CH'],
  },
  {
    alias: 'seafood',
    title: 'Seafood',
  ...
  },
  {
    ...
    title: 'Shaved Ice',
    parents: ['food'],
    country_whitelist: ['JP', 'US', 'MX', 'AR', 'CL', 'CZ', 'IT', 'SG', 'TW'],
  },
  {
    alias: 'shavedsnow',
    title: 'Shaved Snow',
    parents: ['food'],
    country_whitelist: ['HK', 'US', 'SG', 'TW', 'MY', 'CA'],
  },
  {
    alias: 'sicilian',
    title: 'Sicilian',
    parents: ['italian'],
    country_whitelist: ['FR', 'CZ', 'US', 'IT', 'PL'],
  },
  {
    alias: 'signature_cuisine',
    title: 'Signature Cuisine',
    parents: ['restaurants'],
    country_whitelist: ['MX', 'AR', 'PT', 'CL', 'DK', 'ES', 'SE', 'NO'],
  },
  {
    alias: 'singaporean',
    title: 'Singaporean',
  ...
  },
  {
    ...
    title: 'Smokehouse',
    parents: ['food'],
    country_blacklist: ['TR', 'FR', 'MX', 'AR', 'PL', 'IT', 'CL'],
  },
  {
    alias: 'soba',
    title: 'Soba',
  ...
  },
  {
    ...
    title: 'Somali',
    parents: ['restaurants'],
    country_whitelist: ['DE', 'AT', 'US', 'IT', 'PL', 'CH'],
  },
  {
    alias: 'soulfood',
    title: 'Soul Food',
    parents: ['restaurants'],
    country_whitelist: ['IE', 'US', 'PL', 'GB', 'NO', 'CA', 'ES', 'SE', 'NL'],
  },
  {
    alias: 'soup',
    title: 'Soup',
  ...
  },
  {
    ...
    title: 'South African',
    parents: ['african'],
    country_whitelist: ['AU', 'FR', 'BE', 'US', 'IT', 'CA'],
  },
  {
    alias: 'southern',
    title: 'Southern',
    parents: ['restaurants'],
    country_whitelist: ['IE', 'US', 'GB', 'NZ', 'CA', 'PL', 'SE', 'NL', 'TR'],
  },
  {
    alias: 'spanish',
    title: 'Spanish',
  ...
  },
  {
    ...
    title: 'Swiss Food',
    parents: ['restaurants'],
    country_whitelist: ['DE', 'CZ', 'ES', 'MX', 'AR', 'CH', 'CL'],
  },
  {
    alias: 'syrian',
    title: 'Syrian',
  ...
  },
  {
    ...
    title: 'Taiwanese',
    parents: ['restaurants'],
    country_blacklist: ['FI', 'CZ', 'ES', 'PT', 'TR'],
  },
  {
    alias: 'taiyaki',
    title: 'Taiyaki',
  ...
  },
  {
    ...
    title: 'Teppanyaki',
    parents: ['japanese'],
    country_whitelist: ['JP', 'US', 'MX', 'NZ', 'HK', 'AU', 'SG', 'TW'],
  },
  {
    alias: 'tex-mex',
    title: 'Tex-Mex',
    parents: ['restaurants'],
    country_blacklist: ['ES', 'AU', 'DK', 'PT'],
  },
  {
    alias: 'thai',
    title: 'Thai',
  ...
  },
  {
    ...
    title: 'Trattorie',
    parents: ['restaurants'],
    country_whitelist: ['FR', 'IT', 'AR', 'PL', 'CH', 'CL'],
  },
  {
    alias: 'trinidadian',
    title: 'Trinidadian',
  ...
  },
  {
    ...
    title: 'Udon',
    parents: ['japanese'],
    country_whitelist: ['HK', 'FI', 'DK', 'JP', 'TW', 'NO', 'SE'],
  },
  {
    alias: 'ukrainian',
    title: 'Ukrainian',
    parents: ['restaurants'],
    country_blacklist: ['ES', 'DK', 'TR'],
  },
  {
    alias: 'unagi',
    title: 'Unagi',
  ...
  },
  {
    ...
    title: 'Venezuelan',
    parents: ['latin'],
    country_whitelist: ['ES', 'FR', 'CA', 'US', 'AR', 'PT', 'CL'],
  },
  {
    alias: 'venison',
    title: 'Venison',
  ...
  },
  {
    ...
    title: 'Wraps',
    parents: ['restaurants'],
    country_whitelist: ['DK', 'CZ', 'US', 'SE', 'NO', 'PT', 'TR'],
  },
  {
    alias: 'yakiniku',
    title: 'Yakiniku',
  ...
  },
  {
    ...
    title: 'Yugoslav',
    parents: ['restaurants'],
    country_whitelist: ['AU', 'FR', 'BE', 'IT', 'SE', 'PT'],
  },
  {
    alias: 'zapiekanka',
    title: 'Zapiekanka',
